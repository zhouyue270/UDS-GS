...
# castrack_path = '/home/detection/zhouyue/UDS-GS/waymo/castrack/seq_infos/val/result.json'
...
def main():
    ...
    parser.add_argument('--root_dir', type=str, default='/home/detection/zhouyue/UDS-GS')
    parser.add_argument('--save_dir', type=str, default='/home/detection/zhouyue/UDS-GS')
    parser.add_argument('--track_file', type=str, default='/home/detection/zhouyue/UDS-GS/waymo/castrack/seq_infos/val/result.json')
